...
public class CustomerAPI {
	...
	@PostMapping("/login")
	public ResponseEntity<UserDTO> authenticateCustomer(@RequestBody UserCredentialDTO userCredentialDTO)
		...
		logger.info(environment.getProperty("CustomerApi.USER_LOGGED_IN_SUCCESSFULLY") + userDTO.getEmail());
